                ...
                <form action="{{ route('books.update', $book->id) }}" method="POST">
                    ...
                    @method('PUT') <div class="row g-3">
                        <div class="col-md-12">
                            ...
                            <input type="text" name="title" id="title" class="form-control" value="{{ old('title', $book->title) }}" minlength="4" maxlength="255" required>
                        </div>

                        <div class="col-md-6">
                            <label for="author" class="form-label fw-bold">Autor</label>
                            <input type="text" name="author" id="author" class="form-control" value="{{ old('author', $book->author) }}" minlength="4" maxlength="255" required>
                        </div>

                        <div class="col-md-6">
                            <label for="publisher" class="form-label fw-bold">Editorial</label>
                            <input type="text" name="publisher" id="publisher" class="form-control" value="{{ old('publisher', $book->publisher) }}" minlength="4" maxlength="255" required>
                        </div>

                        <div class="col-md-4">
                            <label for="published_year" class="form-label fw-bold">Año de Publicación</label>
                            <input type="number" name="published_year" id="published_year" class="form-control" value="{{ old('published_year', $book->published_year) }}" min="1000" max="9999" step="1" required>
                        </div>

                        <div class="col-md-4">
                            <label for="category" class="form-label fw-bold">Categoría</label>
                            <input type="text" name="category" id="category" class="form-control" value="{{ old('category', $book->category) }}" minlength="4" maxlength="255" required>
                        </div>

                        <div class="col-md-4">
                            <label for="stock" class="form-label fw-bold">Cantidad disponible</label>
                            <input type="number" name="stock" id="stock" class="form-control" value="{{ old('stock', $book->stock) }}" min="0" step="1" required>
                        </div>
